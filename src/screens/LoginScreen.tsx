            ...
            <View style={styles.overlay}>
                ...
                >
                    <Animated.View style={[styles.formContainer, containerStyle, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
                        ...
                        <Text style={[styles.title, textStyle]}>Welcome Back</Text>
                        <Text style={[styles.subtitle, subTextStyle]}>Sign in to continue your learning journey</Text>
...
const styles = StyleSheet.create({
    ...
    inputContainer: {
        ...
        marginBottom: 8, // reduced margin to fit error text below if needed
        height: 56,
        width: '100%',
    },
    inputIcon: {
